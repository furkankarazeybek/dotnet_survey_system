...
namespace Survey_System.Controllers
{
    public class PersonController : BaseController
    {
        ...
        public ActionResult Create(Person person, string AdminCheck)
        {
            ...
            if (person.NameSurname != null)
            {
                ...
                if(AdminCheck == Constants.AnswerType.Yes)
                {
                    person.IsAdmin = true;
        ...
        [HttpPost]
        public ActionResult Edit(Person person, string AdminCheck)
        {
